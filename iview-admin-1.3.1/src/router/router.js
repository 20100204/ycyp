...
export const appRouter = [
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'index',   display:true,title: '预售管理', name: 'activity_index', component: () => import('@/views/activity/preorder/index.vue')},
            {
                path: 'preorderadd',
                icon: 'jet',
                display:false,
    ...
    },
    {
        ...
        component: Main,
        children: [
            {path: 'index',display:true, title: '权限管理', name: 'access_index', component: () => import('@/views/access/access.vue')}
        ]
    },
    {
        path: '/access-test',
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'image-editor',display:true,
                icon: 'crop',
                name: 'image-editor',
                title: '图片预览编辑',
            ...
            {
                path: 'draggable-list',display:true,
                icon: 'arrow-move',
                name: 'draggable-list',
                title: '可拖拽列表',
            ...
            {
                path: 'area-linkage',display:true,
                icon: 'ios-more',
                name: 'area-linkage',
                title: '城市级联',
            ...
            {
                path: 'split-pane-page',display:true,
                icon: 'ios-pause',
    ...
    },
    {
        ...
        children: [
            {
                path: 'artical-publish',display:true,
                title: '文章发布',
